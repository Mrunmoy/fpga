...
HD_PWD='D:/projects/github/mrunmoy/fpga/led_pmod/led_pmod.runs/design_1_PmodGPIO_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodGPIO_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodGPIO_0_0.tcl
